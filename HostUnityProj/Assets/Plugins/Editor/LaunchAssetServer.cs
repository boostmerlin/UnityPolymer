...
namespace Ginkgo
{
    ...
    {
        const string kLocalAssetServerMenu = "Ginkgo/Local Asset Server";
        ...
        static void Run()
        {
            ...
            ProcessStartInfo startInfo = new ProcessStartInfo("python", "-m http.server " + GinkgoConfig.Selfie.ServerPort);
            ...
            {
                Log.Common.PrintError("Unable Start AssetServer process");
            }
            else
            {
                instance.m_serverPID = launchProcess.Id;
                Log.Common.Print("Local AssetServer Listen: {0}, Root Dir: {1}", GinkgoConfig.Selfie.ServerPort, serverroot);
            }
        }
    }
}