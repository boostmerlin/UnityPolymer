...
namespace Ginkgo
{
    public class BuilderConfig : ScriptableObject
    {
        ...
        void OnEnable()
        {
            ...
            bundleOutRoot = Path.Combine(path, GinkgoConfig.Selfie.ExternalAssets);
        }
    ...
    {
        const string kMenuXBuild = "Ginkgo/Bundle Build/X-Build %#x";
        const string kMenuQuickBundle = "Ginkgo/Bundle Build/Q-Build %#q";
