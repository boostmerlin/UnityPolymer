    ...
    public class Container : IContainer
    {
        ...
        public IEnumerable<object> ResolveAll(Type type)
        {
            ...
            foreach (KeyValuePair<Tuple<Type, string>, Type> kv in Mappings)
            {
                ...
                {
#if NETFX_CORE
                    var condition = type.GetTypeInfo().IsSubclassOf(kv.Key.Item1);
#else
        ...
        public object Resolve(Type baseType, string name = null, bool requireInstance = false, object[] constructorArgs = null)
        {
            ...
            return ResolveNew(baseType, name, constructorArgs);
        }

        public T ResolveNew<T>(string name = null, object[] args = null) where T : class
        {
            return (T)ResolveNew(typeof(T), name, args);
        }

        public object ResolveNew(Type baseType, string name = null, object[] constructorArgs = null)
        {
