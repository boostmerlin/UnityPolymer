...
namespace Ginkgo
{
    ...
    public class DebugTimer
    {
        ...
        static string[] logColors = new string[] { "green", "yellow", "red" };
        public static void END(string name)
        {
            ...
            {
                commonWatch.Stop();
                var elapsed = commonWatch.ElapsedMilliseconds;
                ...
                var s = string.Format("<color={2}>$$$$$$$$ {0} takes: {1} ms </color>", name, elapsed, logColors[i]);
                Log.TimeCost.Print(s);
